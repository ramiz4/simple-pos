  ...
  template: `
    <div class="min-h-screen bg-linear-to-br from-purple-50 to-blue-50 flex">
      ...
      <div class="flex-1 flex flex-col min-w-0 h-screen lg:pl-72">
        ...
        <header
          class="lg:hidden fixed top-0 left-0 right-0 z-30 bg-white/70 backdrop-blur-md border-b border-white/20 pt-[env(safe-area-inset-top)]"
        >
        ...
        <main
          class="flex-1 overflow-y-auto pb-4 px-4 lg:p-8 custom-scrollbar relative"
