...
describe('PlatformService', () => {
  ...
  beforeEach(() => {
    ...
    originalTauri = (window as unknown as TauriWindow).__TAURI__;
  });
  ...
  afterEach(() => {
    ...
    if (originalTauri === undefined) {
      ...
      (window as unknown as TauriWindow).__TAURI__ = originalTauri;
    }
  });
  ...
  describe('Tauri environment detection', () => {
    it('should detect Tauri environment when __TAURI__ is present', () => {
      ...
      (window as unknown as TauriWindow).__TAURI__ = {};
    ...
    it('should not detect Tauri when __TAURI__ is not an object', () => {
      ...
      (window as unknown as TauriWindow).__TAURI__ = 'string';
    ...
    it('should not detect Tauri when __TAURI__ is null', () => {
      ...
      (window as unknown as TauriWindow).__TAURI__ = null;
