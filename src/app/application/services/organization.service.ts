...
export class OrganizationService {
  ...
  async createOrganization(name: string, email: string): Promise<Organization> {
    ...
    if (existing) {
      throw new Error(
        'An organization is already registered with this email address. Please use a different email or contact support if you believe this is an error.',
      );
    }
