...
import { OrderStatusEnum, OrderTypeEnum, TableStatusEnum, UserRoleEnum } from '../../domain/enums';
...
export class SeedService {
  ...
  private async seedProducts(categories: Map<string, number>): Promise<Map<string, number>> {
    ...
    const products = [
      // Pizzas
      {
        ...
        categoryId: categories.get('Pizzas')!,
        price: 9.99,
        stock: 50,
        isAvailable: true,
      },
      ...
      {
        name: 'Classic Burger',
        categoryId: categories.get('Burgers')!,
        price: 8.99,
        stock: 40,
        isAvailable: true,
      },
      ...
      // Pasta
      {
        ...
        categoryId: categories.get('Pasta')!,
        price: 10.99,
        stock: 35,
        isAvailable: true,
      },
      ...
      {
        name: 'Caesar Salad',
        categoryId: categories.get('Salads')!,
        price: 7.99,
        stock: 25,
        isAvailable: true,
      },
      ...
      {
        name: 'Coca Cola',
        categoryId: categories.get('Beverages')!,
        price: 2.5,
        stock: 100,
        isAvailable: true,
      },
      ...
      {
        name: 'Tiramisu',
        categoryId: categories.get('Desserts')!,
        price: 6.99,
        stock: 20,
        isAvailable: true,
      },
  ...
  private async seedVariants(products: Map<string, number>): Promise<void> {
    ...
    const variants = [
      // Pizza sizes
      { productId: products.get('Margherita Pizza')!, name: 'Small (10")', priceModifier: -2.0 },
      { productId: products.get('Margherita Pizza')!, name: 'Medium (12")', priceModifier: 0 },
      { productId: products.get('Margherita Pizza')!, name: 'Large (14")', priceModifier: 3.0 },
      { productId: products.get('Pepperoni Pizza')!, name: 'Small (10")', priceModifier: -2.0 },
      { productId: products.get('Pepperoni Pizza')!, name: 'Medium (12")', priceModifier: 0 },
      { productId: products.get('Pepperoni Pizza')!, name: 'Large (14")', priceModifier: 3.0 },
      { productId: products.get('Vegetarian Pizza')!, name: 'Small (10")', priceModifier: -2.0 },
      { productId: products.get('Vegetarian Pizza')!, name: 'Medium (12")', priceModifier: 0 },
      { productId: products.get('Vegetarian Pizza')!, name: 'Large (14")', priceModifier: 3.0 },
      // Burger options
      { productId: products.get('Classic Burger')!, name: 'Single', priceModifier: 0 },
      { productId: products.get('Classic Burger')!, name: 'Double', priceModifier: 3.0 },
      { productId: products.get('Cheese Burger')!, name: 'Single', priceModifier: 0 },
      { productId: products.get('Cheese Burger')!, name: 'Double', priceModifier: 3.0 },
      { productId: products.get('Bacon Burger')!, name: 'Single', priceModifier: 0 },
      { productId: products.get('Bacon Burger')!, name: 'Double', priceModifier: 3.0 },
      // Beverage sizes
      { productId: products.get('Coca Cola')!, name: 'Small (250ml)', priceModifier: -0.5 },
      { productId: products.get('Coca Cola')!, name: 'Medium (500ml)', priceModifier: 0 },
      { productId: products.get('Coca Cola')!, name: 'Large (750ml)', priceModifier: 1.0 },
      { productId: products.get('Orange Juice')!, name: 'Small (250ml)', priceModifier: -0.5 },
  ...
  private async seedProductIngredients(
    ...
    const productIngredients = [
      ...
      {
        productId: products.get('Margherita Pizza')!,
        ingredientId: ingredients.get('Flour')!,
        quantity: 200,
      },
      {
        productId: products.get('Margherita Pizza')!,
        ingredientId: ingredients.get('Tomato Sauce')!,
        quantity: 100,
      },
      {
        productId: products.get('Margherita Pizza')!,
        ingredientId: ingredients.get('Mozzarella')!,
        quantity: 150,
      },
      {
        productId: products.get('Margherita Pizza')!,
        ingredientId: ingredients.get('Basil')!,
        quantity: 5,
      },
      // Pepperoni Pizza ingredients
      {
        productId: products.get('Pepperoni Pizza')!,
        ingredientId: ingredients.get('Flour')!,
        quantity: 200,
      },
      {
      ...
      // Burgers ingredients
      {
        productId: products.get('Classic Burger')!,
        ingredientId: ingredients.get('Ground Beef')!,
        quantity: 150,
      },
      {
        productId: products.get('Classic Burger')!,
        ingredientId: ingredients.get('Lettuce')!,
        quantity: 30,
      },
      {
        productId: products.get('Classic Burger')!,
        ingredientId: ingredients.get('Tomato')!,
        quantity: 40,
      },
      {
        productId: products.get('Classic Burger')!,
        ingredientId: ingredients.get('Onion')!,
        quantity: 20,
      },
      {
        productId: products.get('Cheese Burger')!,
        ingredientId: ingredients.get('Ground Beef')!,
        quantity: 150,
      },
      {
      ...
      // Pasta ingredients
      {
        productId: products.get('Spaghetti Bolognese')!,
        ingredientId: ingredients.get('Pasta')!,
        quantity: 200,
      },
      {
        productId: products.get('Spaghetti Bolognese')!,
      ...
      {
        productId: products.get('Carbonara')!,
        ingredientId: ingredients.get('Pasta')!,
        quantity: 200,
      },
      {
      ...
      // Salads ingredients
      {
        productId: products.get('Caesar Salad')!,
        ingredientId: ingredients.get('Lettuce')!,
        quantity: 150,
      },
      {
      ...
      {
        productId: products.get('Greek Salad')!,
        ingredientId: ingredients.get('Lettuce')!,
        quantity: 100,
      },
      {
      ...
      {
        productId: products.get('Greek Salad')!,
        ingredientId: ingredients.get('Olive Oil')!,
        quantity: 20,
      },
    ];
