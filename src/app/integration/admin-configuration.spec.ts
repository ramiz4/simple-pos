...
describe('Phase 2: Admin Configuration Layer', () => {
  ...
  describe('Table Management CRUD', () => {
    ...
    it('should update table details', async () => {
      ...
      const updated = await tableService.update(table.id!, { seats: 6 });
  ...
  describe('Category Management CRUD', () => {
    it('should create and retrieve a category', async () => {
      ...
      const retrieved = await categoryService.getById(category.id!);
      expect(retrieved).toBeDefined();
  ...
  describe('Product Management CRUD', () => {
    ...
    it('should update product details', async () => {
      ...
      expect(updated.price).toBe(6.50);
    ...
    it('should toggle product availability', async () => {
      ...
      const toggled = await productService.toggleAvailability(product.id!);
  ...
  describe('Variant Management CRUD', () => {
    it('should create and retrieve a variant', async () => {
      ...
      expect(variant.priceModifier).toBe(1.00);
    ...
    it('should update variant details', async () => {
      ...
      const updated = await variantService.update(variant.id!, {
        priceModifier: -0.50
      });
  ...
  describe('Extra Management CRUD', () => {
    it('should create and retrieve an extra', async () => {
      ...
      expect(extra.price).toBe(1.50);

      const retrieved = await extraService.getById(extra.id!);
      expect(retrieved).toBeDefined();
    ...
    it('should update extra details', async () => {
      ...
      expect(updated.price).toBe(2.50);
    });
  ...
  describe('Ingredient Management CRUD', () => {
    it('should create and retrieve an ingredient', async () => {
      ...
      const retrieved = await ingredientService.getById(ingredient.id!);
      expect(retrieved).toBeDefined();
    ...
    it('should update ingredient stock', async () => {
      ...
      const updated = await ingredientService.update(ingredient.id!, {
        stockQuantity: 75
      });
